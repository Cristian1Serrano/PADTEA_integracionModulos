            ...
            <div class="col-md-12">              
              <div class="box box-primary direct-chat direct-chat-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">CREA UNA PUBLICACION</h3>
        ...
        <div class="col-md-4">          
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <?php $amistade = mysqli_query("SELECT * FROM amigos WHERE para = '".$_SESSION['id']."' AND estado = '0' order by id_ami desc LIMIT 4");
              while($am = mysqli_fetch_array($amistade)) { 

                $use = mysqli_query("SELECT * FROM usuarios WHERE id_use = '".$am['de']."'");
        ...
        <div class="col-md-4">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php $registrados = mysqli_query("SELECT avatar,usuario,fecha_reg FROM usuarios order by id_use desc limit 8");
